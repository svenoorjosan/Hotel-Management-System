<!-- select_room.php -->
<html>
<head><title>View Room</title></head>
<body>
<center><h2>View Room Details</h2></center>
<hr width="40%">
...
if ($result->num_rows > 0) {
    ...
    echo "<form action=\"selectroom.php\" method=\"post\">";
    ...
    echo "<center><p>No rooms in system!</p></center>";
}
?>
